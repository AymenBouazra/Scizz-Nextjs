   ...
   >
    ...
    <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
     ...
     <button
      type="submit"
      disabled={isLoading}
      className={`${isLoading ? "cursor-not-allowed bg-blue-800" : 'bg-blue-600'} w-full px-6 py-3 text-white font-semibold rounded-lg hover:bg-blue-700 transition duration-200"}`}
     >
      {isLoading ? <div role="status" className="flex justify-center items-center w-full gap-3">
